...
public partial class GameContext {
    ...
    public GameEntity controlledByPlayerEntity { get { return GetGroup(GameMatcher.ControlledByPlayer).GetSingleEntity(); } }

    public bool isControlledByPlayer {
        get { return controlledByPlayerEntity != null; }
        set {
            var entity = controlledByPlayerEntity;
            if (value != (entity != null)) {
                if (value) {
                    CreateEntity().isControlledByPlayer = true;
                } else {
                    entity.Destroy();
                }
            }
