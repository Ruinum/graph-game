...
{
    public sealed class CreatorDestroySystem : ReactiveSystemExtended<GameEntity>
    {
        ...
        public CreatorDestroySystem(IContext<GameEntity> context) : base(context)
        {
            _entityIndex = (EntityIndex<GameEntity, GameEntity>) context.GetEntityIndex(Contexts.CreatorEntity);
        }
