...
{
    public sealed class CreatedEntityDestroySystem : ReactiveSystemExtended<GameEntity>
    {
        ...
        public CreatedEntityDestroySystem(IContext<GameEntity> context) : base(context)
        {
            _entityIndex = (EntityIndex<GameEntity, GameEntity>)context.GetEntityIndex(Contexts.GameCreatedEntity);
        }
        ...
        protected override void Execute(GameEntity e)
        {
            ...
            {
                _buffer[i].RemoveGameCreatedEntity();
            }
            _buffer.Clear();
        }
    }
